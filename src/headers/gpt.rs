...
impl PartitionEntry {
    ...
    pub fn type_to_str(&self) -> &str {
        match GUID_TYPE_MAP.get(&self.type_guid) {
...
lazy_static! {
    static ref GUID_TYPE_MAP: HashMap<Uuid, &'static str> = HashMap::from([
        (
        ...
        (uuid!("6A85CF4D-1DD2-11B2-99A6-080020736631"), "Root partition"),
        (uuid!("6A87C46F-1DD2-11B2-99A6-080020736631"), "Swap partition"),
        (uuid!("6A8B642B-1DD2-11B2-99A6-080020736631"), "Backup partition"),
        (uuid!("6A898CC3-1DD2-11B2-99A6-080020736631"), "/usr partition"),
        (uuid!("6A8EF2E9-1DD2-11B2-99A6-080020736631"), "/var partition"),
        (uuid!("6A90BA39-1DD2-11B2-99A6-080020736631"), "/home partition"),
        ...
        (uuid!("85D5E45A-237C-11E1-B4B3-E89A8F7FC3A7"), "Data partition"),
        (uuid!("85D5E45B-237C-11E1-B4B3-E89A8F7FC3A7"), "Swap partition"),
        ...
        (uuid!("114EAFFE-1552-4022-B26E-9B053604CF84"), "Bootloader2"),
        (uuid!("49A4D17F-93A3-45C1-A0DE-F50B2EBE2599"), "Boot"),
        (uuid!("4177C722-9E92-4AAB-8644-43502BFD5506"), "Recovery"),
        (uuid!("EF32A33B-A409-486C-9141-9FFB711F6266"), "Misc"),
        (uuid!("20AC26BE-20B7-11E3-84C5-6CFDB94711E9"), "Metadata"),
        (uuid!("38F428E6-D326-425D-9140-6E0EA133647C"), "System"),
        (uuid!("A893EF21-E428-470A-9E55-0668FD91A2D9"), "Cache"),
        (uuid!("DC76DDA9-5AC1-491C-AF42-A82591580C0D"), "Data"),
        (uuid!("EBC597D0-2053-4B15-8B64-E0AAC75F4DB1"), "Persistent"),
        (uuid!("C5A0AEEC-13EA-11E5-A1B1-001E67CA0C3C"), "Vendor"),
        (uuid!("BD59408B-4514-490D-BF12-9878D963F378"), "Config"),
        (uuid!("8F68CC74-C5E5-48DA-BE91-A0C8C15E9C80"), "Factory"),
        (uuid!("9FDAA6EF-4B3F-40D2-BA8D-BFF16BFB887B"), "Factory (alt)"),
        (uuid!("767941D0-2085-11E3-AD3B-6CFDB94711E9"), "Fastboot / Tertiary"),
        (uuid!("AC6D7924-EB71-4DF8-B48D-E267B27148FF"), "OEM"),
        ...
        (uuid!("BC13C2FF-59E6-4262-A352-B275FD6F7172"), "freedesktop.org OSes (Linux, etc.)	Shared boot loader configuration"),
        ...
        (uuid!("C12A7328-F81F-11D2-BA4B-00A0C93EC93B"), "fuchsia-esp"),
        ...
        (uuid!("5ECE94FE-4C86-11E8-A15B-480FCF35F8E6"), "bootloader"),
        (uuid!("8B94D043-30BE-4871-9DFA-D69556E8C1F3"), "guid-test"),
        (uuid!("A13B4D9A-EC5F-11E8-97D8-6C3BE52705BF"), "Verified boot metadata (slot A)"),
        (uuid!("A288ABF2-EC5F-11E8-97D8-6C3BE52705BF"), "Verified boot metadata (slot B)"),
        (uuid!("6A2460C3-CD11-4E8B-80A8-12CCE268ED0A"), "Verified boot metadata (slot R)"),
        (uuid!("1D75395D-F2C6-476B-A8B7-45CC1C97B476"), "misc"),
        (uuid!("900B0FC5-90CD-4D4F-84F9-9F8ED579DB88"), "emmc-boot1"),
        (uuid!("B2B2E8D1-7C10-4EBC-A2D0-4614568260AD"), "emmc-boot2"),
    ]);
}
